<div class="mt-20 container flex " >
    <div class="w-2/3 pr-4">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($tasks as $task)
                        <tr wire:key='{{ $task->id }}' class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                           ...
                           ss
                            ...
                            @else
                                ...
                                <button wire:click="delete({{ $task->id }})"  wire:confirm="Are you sure you want to delete this task?" class="ml-5 self-center text-red-700"><svg
        ...
        <div class="w-1/3 mt-20 "> @include('livewire.includes.task-list-form')</div>
