<form wire:keydown.ctrl.enter='store' wire:submit.prevent="store" class="container max-w-lg mx-auto">

    <div class="mb-4">
        <label for="taskName" class="block text-sm font-medium text-gray-900 dark:text-white">Task Name</label>
        <input wire:model.live="taskName" type="text" id="taskName"
    ...
    <div class="mb-4">
        <label for="message" class="block text-sm font-medium text-gray-900 dark:text-white">Task description</label>
        <textarea wire:model="taskDescription" id="message" rows="4"
            class="form-input w-full mt-1 rounded-md shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Things to do ..."></textarea>
    ...
    <div class="mb-4">
        <label for="taskAssignedUsers" class="block text-sm font-medium text-gray-900 dark:text-white">Assigned
            Users</label>
    ...
    <div class="mb-4">
        ...
        <input wire:model='files' class="form-input w-full mt-1 rounded-md shadow-sm cursor-pointer dark:text-gray-400"
        ...
        <img class="  w-40 h-40 py-4" src="{{ $file->temporaryUrl() }}" alt="">
        @endforeach
